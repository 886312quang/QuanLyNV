...
const selectLink = createSelector([selectRaw], (ledger) => ledger.link);
...
const selectDiscount = createSelector([selectRaw], (ledger) => ledger.discount);

const selectPaymentMethod = createSelector(
  [selectRaw],
  (ledger) => ledger.paymentMethod,
);
