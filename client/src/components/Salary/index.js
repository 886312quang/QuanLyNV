...
const SalaryPage = () => {
  ...
  const calculateSalary = (e) => {
    ...
    setSalary(6100 * dot * (change / 26) + (revenue / 100) * percent + prize);
  };
    ...
    <ContentWrapper>
      ...
      <Row>
        <Col md={24}>
          ...
          <Text type="danger">
            {" "}
            Lương cứng (26 ngày = 6100) * chấm + Tiền làm khách * phần trăm +
            tiền thưởng
          </Text>
        </Col>
      </Row>
      ...
      <FilterWrapper>
        <Row>
          ...
          <Col md={24} lg={12}>
            <DescriptionItem title="Phần trăm" content={percent + " %"} />
          </Col>
          <Col md={24} lg={12}>
            <DescriptionItem
            ...
            <Title level={2}>
              ...
              <Text type="danger">
                {new Intl.NumberFormat().format(
                  hardSalary + (revenue / 100) * percent + prize,
                )}
              </Text>
            </Title>
          </Col>
