  ...
  produce(state, (draft) => {
    switch (type) {
      ...
      case REPORT_GET_SUCCESS:
        ...
        draft.sumCertificate = calculateFields(draft.reports, "certificate");
        draft.sumCash = calculateFields(draft.reports, "cash");
        draft.sumCertificate = calculateFields(draft.reports, "certificate");
        draft.error = null;
        break;
      ...
      case REPORT_FIND_SUCCESS:
        ...
        draft.sumCertificate = calculateFields(state.reports, "certificate");
        draft.sumCash = calculateFields(draft.reports, "cash");
        draft.sumCertificate = calculateFields(draft.reports, "certificate");
        draft.error = null;
        break;
      ...
      case REPORT_TABLE_ROW_CLICK:
        ...
        draft.sumCash = calculateFields(state.reports, "cash");
        draft.sumCertificate = calculateFields(state.reports, "certificate");
        draft.sumCashSelectedRow = calculateFields(draft.selectedRows, "cash");
        draft.sumCertificateSelectedRow = calculateFields(
          draft.selectedRows,
          "certificate",
        );
